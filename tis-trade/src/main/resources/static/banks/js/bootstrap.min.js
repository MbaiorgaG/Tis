...
+function (a) {
  ...
  if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1 || b[0]
      > 2) {
    throw new Error(
  ...
  d.VERSION = "3.3.6", d.TRANSITION_DURATION = 150, d.prototype.close = function (b) {
    ...
    || (g.removeClass("in"), a.support.transition && g.hasClass("fade") ? g.one(
  ...
  c.VERSION = "3.3.6", c.DEFAULTS = {loadingText: "loading..."}, c.prototype.setState = function (b) {
    ...
    if (b.length) {
      ...
      this.$element.attr("aria-pressed",
          !this.$element.hasClass("active")), this.$element.toggleClass(
          "active")
    }
  };
  var d = a.fn.button;
  a.fn.button = b, a.fn.button.Constructor = c, a.fn.button.noConflict = function () {
    return a.fn.button = d, this
      ...
      function (c) {
        var d = a(c.target);
        d.hasClass("btn") || (d = d.closest(".btn")), b.call(d, "toggle"), a(
            c.target).is('input[type="radio"]') || a(c.target).is(
            'input[type="checkbox"]') || c.preventDefault()
  ...
  var c = function (b, c) {
    ...
    && this.$element.on("keydown.bs.carousel",
        a.proxy(this.keydown, this)), "hover" == this.options.pause
      ...
      return a.support.transition && this.$element.hasClass("slide")
          ? (f.addClass(b), f[0].offsetWidth, e.addClass(h), f.addClass(
            ...
            f.removeClass([b, h].join(" ")).addClass("active"), e.removeClass(
              ...
              "active"), f.addClass(
              "active"), this.sliding = !1, this.$element.trigger(m)), g
      && this.cycle(), this
    }
  };
  var d = a.fn.carousel;
  ...
  var d = function (b, c) {
    this.$element = a(b), this.options = a.extend({}, d.DEFAULTS,
        ...
        ? this.$parent = this.getParent() : this.addAriaAndCollapsedClass(
      ...
      && b.transitioning))) {
        ...
        if (this.$element.trigger(f), !f.isDefaultPrevented()) {
          ...
          this.$element.one("bsTransitionEnd",
              a.proxy(h, this)).emulateTransitionEnd(d.TRANSITION_DURATION)[g](
              this.$element[0][i])
        }
      }
    }
  ...
  g.VERSION = "3.3.6", g.prototype.toggle = function (d) {
    ...
    if (/(38|40|27|32)/.test(c.which) && !/input|textarea/i.test(
        c.target.tagName)) {
      var d = a(this);
  ...
  c.VERSION = "3.3.6", c.TRANSITION_DURATION = 300, c.BACKDROP_TRANSITION_DURATION = 150, c.DEFAULTS = {
    ...
    || (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(), this.$body.addClass(
      ...
      d.$element.parent().length || d.$element.appendTo(
          d.$body), d.$element.show().scrollTop(0), d.adjustDialog(), e
    ...
    && this.$element.hasClass("fade") ? this.$element.one("bsTransitionEnd",
        a.proxy(this.hideModal, this)).emulateTransitionEnd(
      ...
      if (this.$backdrop = a(document.createElement("div")).addClass(
          ...
          "click.dismiss.bs.modal", a.proxy(function (a) {
            return this.ignoreBackdropClick
                ? void (this.ignoreBackdropClick = !1) : void (a.target
                    === a.currentTarget && ("static" == this.options.backdrop
  ...
  c.VERSION = "3.3.6", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
    ...
    if (this.enabled = !0, this.type = b, this.$element = a(
        ...
        a.isFunction(this.options.viewport) ? this.options.viewport.call(this,
    ...
    return c || (c = new this.constructor(b.currentTarget,
        ...
        c)), b instanceof a.Event && (c.inState["focusin" == b.type ? "focus"
        : "hover"] = !0), c.tip().hasClass("in") || "in" == c.hoverState
        ? void (c.hoverState = "in") : (clearTimeout(
            c.timeout), c.hoverState = "in", c.options.delay
    ...
    return c || (c = new this.constructor(b.currentTarget,
        this.getDelegateOptions()), a(b.currentTarget).data("bs." + this.type,
        c)), b instanceof a.Event && (c.inState["focusout" == b.type ? "focus"
        : "hover"] = !1), c.isInStateTrue() ? void 0 : (clearTimeout(
        c.timeout), c.hoverState = "out", c.options.delay
    ...
    if (this.hasContent() && this.enabled) {
      ...
      j && (h = h.replace(i, "") || "top"), f.detach().css(
          ...
          this.options.container) : f.insertAfter(
      ...
      if (j) {
        ...
        && k.top - m < o.top ? "bottom" : "right" == h && k.right + l > o.width
            ? "left" : "left" == h && k.left - l < o.left ? "right"
    ...
    isNaN(g) && (g = 0), isNaN(h)
    && (h = 0), b.top += g, b.left += h, a.offset.setOffset(d[0], a.extend({
      using: function (a) {
    ...
    return this.$element.trigger(g), g.isDefaultPrevented() ? void 0
        : (f.removeClass("in"), a.support.transition && f.hasClass("fade")
            ? f.one("bsTransitionEnd", d).emulateTransitionEnd(
                c.TRANSITION_DURATION) : d(), this.hoverState = null, this)
    ...
    if (!this.$tip && (this.$tip = a(this.options.template), 1
    != this.$tip.length)) {
    ...
    || (c = new this.constructor(b.currentTarget, this.getDelegateOptions()), a(
        b.currentTarget).data("bs." + this.type, c))), b
        ? (c.inState.click = !c.inState.click, c.isInStateTrue() ? c.enter(c)
            : c.leave(c)) : c.tip().hasClass("in") ? c.leave(c) : c.enter(c)
  ...
  function b(c, d) {
    this.$body = a(document.body), this.$scrollElement = a(
        a(c).is(document.body) ? window : c), this.options = a.extend({},
  ...
  b.VERSION = "3.3.6", b.DEFAULTS = {offset: 10}, b.prototype.getScrollHeight = function () {
    ...
    || (c = "position", d = this.$scrollElement.scrollTop()), this.$body.find(
  ...
  c.VERSION = "3.3.6", c.TRANSITION_DURATION = 150, c.prototype.show = function () {
    ...
    function f() {
      g.removeClass("active").find("> .dropdown-menu > .active").removeClass(
          ...
          "aria-expanded", !0), h ? (b[0].offsetWidth, b.addClass("in"))
    ...
    var g = d.find("> .active"),
        h = e && a.support.transition && (g.length && g.hasClass("fade")
            || !!d.find("> .fade").length);
    g.length && h ? g.one("bsTransitionEnd", f).emulateTransitionEnd(
        c.TRANSITION_DURATION) : f(), g.removeClass("in")
  };
  var d = a.fn.tab;
  ...
  c.VERSION = "3.3.6", c.RESET = "affix affix-top affix-bottom", c.DEFAULTS = {
    ...
    if ("bottom" == this.affixed) {
      return null != c ? e + this.unpin <= f.top
    ...
    if (this.$element.is(":visible")) {
      ...
      "object" != typeof d && (f = e = d), "function" == typeof e && (e = d.top(
          this.$element)), "function" == typeof f && (f = d.bottom(
          this.$element));
