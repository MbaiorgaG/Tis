    ...
    return this.each(function () {
      ...
      var methods = {
        init: function () {
          ...
          waitMeObj = $(
              '<div class="' + elemClass + '" data-waitme_id="' + currentID
              + '"></div>');
          ...
          if (effectElemCount > 0) {
            if (_options.effect === 'img') {
              ...
              for (var i = 1; i <= effectElemCount; ++i) {
                ...
                if (createSubElem) {
                  effectElemHTML += '<div class="' + elemClass
                      + '_progress_elem' + i + '"><div style="' + specificAttr
                      + ':' + color + '"></div></div>';
                } else {
                  effectElemHTML += '<div class="' + elemClass
                      + '_progress_elem' + i + '" style="' + specificAttr + ':'
                      + color + '"></div>';
                }
              }
            }
            effectObj = $(
                '<div class="' + elemClass + '_progress ' + _options.effect
                + '" style="' + addStyle + '">' + effectElemHTML + '</div>');
          }
          ...
          if (_options.text) {
            ...
            waitMe_text = $(
                '<div class="' + elemClass + '_text" style="color:' + color
                + ';' + size + '">' + _options.text + '</div>');
          }
          ...
          var waitMeDivObj = $(
              '<div class="' + elemClass + '_content ' + _options.textPos
              + '"></div>');
          ...
          elem.addClass(elemClass + '_container').attr('data-waitme_id',
              currentID).append(waitMeObj);
            ...
            if (_options.effect === 'img') {
              ...
              if (_options.maxSize < elemMax) {
                if (_options.effect == 'stretch') {
                  ...
                  } else if (_options.effect == 'win8' || _options.effect
                      == 'timer' || _options.effect == 'orbit') {
                    offset = '-20%';
                    if (_options.text) {
                      offset = '20%';
                    }
      ...
      function waitMeClose() {
        ...
        elem.find(
            '.' + elemClass + '[data-waitme_id="' + currentID + '"]').remove();
      }
