...
(function () {
  ...
  var uuid = function () {
    ...
    return lut[d0 & 0xff] + lut[d0 >> 8 & 0xff] + lut[d0 >> 16 & 0xff] + lut[d0
        ...
        + lut[d2 >> 24 & 0xff] +
        lut[d3 & 0xff] + lut[d3 >> 8 & 0xff] + lut[d3 >> 16 & 0xff] + lut[d3
        >> 24 & 0xff];
  };
  ...
  var invokeLoadingOverlay = function (config) {
    ...
    return lo.cache(param, function () {
      ...
      var cancelSpinner = function cancelSpinnerCallee(spinHandle,
          cancelledCallback, cancelUUID) {
          ...
          if (spinTime < spinMin) {
            ...
            if (typeof cancelledCallback === 'function') {
              ...
              for (var c in cancelled_hash[spinHandle].cb_hash) {
                if (!cancelled_hash[spinHandle].cb_hash[c].invoked
                    && (typeof cancelled_hash[spinHandle].cb_hash[c].cb
                        === 'function')) {
      ...
      appendHtmlToTarget(param.target, heredoc(function () {
        /*
                    ...
                    */
      }).replace(/%wrapClass%/g, param['wrapClass']).replace(/%spinClass%/g,
          param['spinClass']));
