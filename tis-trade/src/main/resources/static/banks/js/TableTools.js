 ...
 */
	 ...
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
        ...
        "_fnButtonDefinations": function (buttonSet, wrapper) {
          ...
          for (var i = 0, iLen = buttonSet.length; i < iLen; i++) {
            if (typeof buttonSet[i] == "string") {
              ...
              var o = $.extend({}, TableTools.BUTTONS[buttonSet[i].sExtends],
                  true);
        ...
        "_fnButtonBase": function (o, bCollectionButton) {
          ...
          nButton.setAttribute('id', "ToolTables_" + this.s.dt.sInstance + "_"
	 ...
	 */
        ...
        "_fnCollectionShow": function (nButton, oConfig) {
          ...
          if (iDivY + iDivHeight > iDocHeight) {
            nHidden.style.top = (iDivY - iDivHeight - $(nButton).outerHeight())
                + "px";
          }
        ...
        "_fnCollectionHide": function (nButton, oConfig) {
          ...
          if (this.dom.collection.collection !== null) {
            $(this.dom.collection.collection).animate({"opacity": 0}, 500,
                function (e) {
                  this.style.display = "none";
                });

            $(this.dom.collection.background).animate({"opacity": 0}, 500,
                function (e) {
	 ...
	 */
        ...
        "_fnRowSelectConfig": function () {
          if (this.s.master) {
            ...
            // Row selection
            $(dt.nTBody).on('click.DTTT_Select', this.s.custom.sRowSelector,
                function (e) {
                  ...
                  if (select.type == 'os') {
                    if (e.ctrlKey || e.metaKey) {
                      ...
                      if (that.fnIsSelected(row) && that.fnGetSelected().length
                          === 1) {
                        that._fnRowDeselect(row, e);
                      } else {
                        that.fnSelectNone();
            ...
            dt.oApi._fnCallbackReg(dt, 'aoRowCreatedCallback',
        ...
        "_fnRowDeselect": function (src, e) {
          ...
          // User defined pre-selection function
          if (this.s.select.preRowSelect !== null
              && !this.s.select.preRowSelect.call(this, e, anDeselectedTrs,
                  false)) {
            return;
          }
          ...
          if (oConfig.bHeader) {
            ...
            for (i = 0, iLen = dt.aoColumns.length; i < iLen; i++) {
              if (aColumnsInc[i]) {
                ...
                aRow.push(this._fnBoundData(sLoopData, oConfig.sFieldBoundary,
                    regex));
              }
            }
          ...
          for (j = 0, jLen = aDataIndex.length; j < jLen; j++) {
            ...
            for (i = 0, iLen = dt.aoColumns.length; i < iLen; i++) {
              if (aColumnsInc[i]) {
                ...
                var mTypeData = dt.oApi._fnGetCellData(dt, aDataIndex[j], i,
                    'display');
                if (oConfig.fnCellRender) {
                  sLoopData = oConfig.fnCellRender(mTypeData, i, tr,
                      aDataIndex[j]) + "";
            ...
            if (oConfig.bOpenRows) {
              ...
              if (arr.length === 1) {
                sLoopData = this._fnBoundData($('td', arr[0].nTr).html(),
        ...
        "_fnPrintStart": function (oConfig) {
          ...
          for (var cFeature in anFeature) {
            if (cFeature != 'i' && cFeature != 't' && cFeature.length == 1) {
              for (var i = 0, iLen = anFeature[cFeature].length; i < iLen;
                  i++) {
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
      ...
      TableTools._fnEventDispatch = function (that, type, node, selected) {
        ...
        for (var i = 0, iLen = listeners.length; i < iLen; i++) {
          if (that.dom.table == listeners[i].that.dom.table && listeners[i].type
              == type) {
